...
import billImage from '../assets/bill.jpg'; // Billing image import
    ...
    <div className="flex flex-col md:flex-row">
      ...
      <div className="md:w-1/2 p-4">
        ...
        <div className="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4 mb-4">
          ...
          <p>
            We have built an agent that queries our database for information based on your requests. 
        ...
        <p className="mb-4">
          In the meantime, we invite you to enjoy our NoodleGPT service free of charge. This 
        ...
        <p>
          ...
          with NoodleGPT. Stay tuned for updates on the billing feature!
        </p>
      </div>
    </div>
  );
...
export default Billing; // Exporting the Billing component to be used in app.js
